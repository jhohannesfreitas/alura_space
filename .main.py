...
No nosso caso, o comando era git remote add origin https://github.com/jhohannesfreitas/alura_space.git, mas o link será diferente para cada repositório. Se não funcionar, é porque já foi criado.
...
- crie uma pasta dentro de setup, chamada static
